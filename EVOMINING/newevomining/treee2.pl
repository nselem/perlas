  ...
  <div class="container"> <!-- CONTENEDOR PRINCIPAL 12col -->
    <div class="col-md-12">
      <table class="table table-bordered" id="centrado">
        <tr>
          <td>
            <div class="col-md-4">*Roll the mouse wheel to zoom in and out of the image. </div>
            <div class="col-md-4">*Use mouse pointer to move the image by click and dragging.</div>
