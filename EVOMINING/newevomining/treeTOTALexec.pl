...
open(OP, "$apacheCGIpath/$outdir/blast/seqf/tree/$numFile.p.svg");
 while(<OP>){
  $string=$string.$_;
 }
...
action="http://10.10.100.156/cgi-bin/newevomining/tree2_2TOTALexec.pl?$numFile&&$outdir"
target="iframeA">
...
id="GenomeName" checked="checked" type="checkbox"> Genome Name</label><label>
...
src="http://10.10.100.156/cgi-bin/newevomining/tree2_2TOTALexec.pl?$numFile&&$outdir"
