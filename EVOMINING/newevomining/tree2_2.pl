...
#}
#close INPUT;
system "cp /var/www/newevomining/$outdir/blast/seqf/tree/ornament.$numFile /var/www/newevomining/$outdir/blast/seqf/tree/ornament.$numFile.edit";
...
open(OPT, ">/var/www/newevomining/$outdir/blast/seqf/tree/$numFile.prueba2.svg");
