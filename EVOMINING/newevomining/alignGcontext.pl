 ...
 while ($xef = <FF>){
    ...
    foreach my $xc (@dat){
	  ...
	  #print qq |<div><td>$array[1]</td></div>|;
	    ...
	    print qq |</table>|;
	    print qq |</td>|;
	   print qq |<div><td ><a href="http://10.10.100.156/cgi-bin/newevomining/tree2_2TOTALexec.pl?$array2[0]&&$outdir" target="_blank">check tree</a><br><a href="http://10.10.100.156/newevomining/$outdir/blast/seqf/tree/$array2[0].tree" target="_blank"> Download newick_tree</a></td></div>|;
