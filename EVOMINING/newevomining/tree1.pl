...
action="http://10.10.100.24/cgi-bin/newevomining/tree2.pl?$numFile"
target="iframeA">
...
accesskey="1" type="checkbox"> Round Tree</label></td>
...
<td width="164">Aply changes <input name="aply" id="aply"
...
src="http://10.10.100.24/cgi-bin/newevomining/tree2.pl?$numFile"
